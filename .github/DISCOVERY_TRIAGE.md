...
| [headroom](https://github.com/headroomlabs-ai/headroom) | **Accepted** — Apache-2.0 context compression for tool outputs and RAG chunks. The deferral was a scope question, not a quality one; resolved by opening Retrieval & Reranking § Context Compression, where it is listed alongside LLMLingua. |
